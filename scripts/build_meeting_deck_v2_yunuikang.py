...
FIGS = "/tmp/claude-20060/-home-yunuikang-yunuikang-work-distserving/29ca42eb-bc32-4350-af3e-f331c8112421/scratchpad/figs_v2"
OUT  = "/home/yunuikang/yunuikang_work/distserving/slides/2026-07-07_meeting_deep-analysis_yunuikang_v2.pptx"
...
"분석을 끝냈습니다. (f) SWE 재현인 작업 6은 스윕이 방금 끝났는데, 뒤에서 보시겠지만 tr이 세 지표 모두에서 "
"이겨서 R 모델 예측이 그대로 적중했습니다. (d) 원인을 수치로 증명하라는 핵심 요구인 작업 4 실험 C는 아직 "
"서버에서 돌고 있습니다. 중요한 건 여섯 작업이 전부 'R 모델' 하나로 이어진다는 점입니다.")
...
textbox(s, 7.17, 1.95, 5.4, 4.4,
        [[("완료 · 진행 중 · 다음", 15, AMBER, True)],
         [("⑥ SWE 스윕 완료 — tr 승 확정 +78~84%", 12.5, GREEN, True)],
         [("   (R 예측 적중: 두 실데이터 TraceLab 패·SWE 승)", 11, GREEN, False)],
         [("④ 실험 C — R을 1 경계 위로 넘겨 인과 확정", 12.5, INK, False)],
         [("   (진행 중, 부분결과 이미 예측선 위)", 11, GRAY, False)],
         [("", 6, INK, False)],
...
"이미 예측과 맞고 있습니다. 그리고 오른쪽 위처럼 SWE 스윕은 이미 끝났고 tr이 78에서 84% 이겨서 R 예측이 "
"적중했습니다. 정리하면 R 모델이 서로 반대인 두 실제 워크로드, TraceLab에선 tr 패, SWE에선 tr 승을 모두 "
"미리 맞혔습니다. 그래서 tr이 지는 건 tr이 나빠서가 아니라 워크로드의 R이 1보다 작아서라는 게 확정됐습니다. "
