...
from LLM_CALL_p3_yunuikang import get_llm_response
...
MODEL_MAPPING = {
    ...
    "reasoner-1": "glm-4.5-flash",
    "reasoner-2": "glm-4.5-flash",
    "reasoner-3": "glm-4.5-flash",

    # All search → gpt-5-mini (OpenAI)
    "search-1": "glm-4.5-flash",
    "search-2": "glm-4.5-flash",
    "search-3": "glm-4.5-flash",

    # All answer (including math) → Together-hosted gpt-oss-120b
    "answer-1": "glm-4.5-flash",
    "answer-2": "glm-4.5-flash",
    "answer-3": "glm-4.5-flash",
    "answer-4": "glm-4.5-flash",
    "answer-math-1": "glm-4.5-flash",
    "answer-math-2": "glm-4.5-flash",
}
TOOL_PRICING = {
    "gpt-5": {
    ...
    with task_context(
        ...
        try:
            ...
            if arguments["tool"] == "enhance_reasoning":
                ...
                if "gpt-5" in model_name.lower() or "glm" in model_name.lower():
            ...
            if arguments["tool"] == "answer":
                ...
                elif "gpt-5" in arguments["model"].lower() or "glm" in arguments["model"].lower():
                    model_name = arguments["model"]
                    prompt2 = prompt + (
