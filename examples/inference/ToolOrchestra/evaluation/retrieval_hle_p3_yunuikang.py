...
def load_model(model_path: str, use_fp16: bool = False):
    if 'Qwen3-Embedding-8B' in model_path or model_path in ['/home/yunuikang/yunuikang_work/scratch/p3_assets/embedder']:
...
config = Config(
    ...
    retrieval_topk=5,
    faiss_gpu=False,
    retrieval_model_path='/home/yunuikang/yunuikang_work/scratch/p3_assets/embedder',
